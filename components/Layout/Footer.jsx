...
const styles = {
  container: tw`sticky top-[100vh] bg-zinc-100`,
  inner: tw`container mx-auto flex flex-col flex-wrap items-center justify-between`,
  ul: tw`flex mx-auto text-neutral-500 text-center`,
  li: tw`p-2 cursor-pointer hover:underline`,
  footer: tw`flex mx-auto text-neutral-500 text-center`,
  li2: tw`fill-current text-white`,
}
